document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateButtonStates() {
        ...
        if (numRows >= maxRows) appendRowBtn.disabled = true;
        else appendRowBtn.disabled = false;
        if (numRows <= minRows) removeRowBtn.disabled = true;
        else removeRowBtn.disabled = false;
        if (numColumns >= maxColumns) appendColumnBtn.disabled = true;
        else appendColumnBtn.disabled = false;
        if (numColumns <= minColumns) removeColumnBtn.disabled = true;
        else removeColumnBtn.disabled = false;
    }
});
